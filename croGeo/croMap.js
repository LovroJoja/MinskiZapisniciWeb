...
const regionKeys = {"MM": 1,"VP":2,"KK":3,"OB":4,"IS":5,"DN":6,"SM":7,"BP":8,"KR":9,"ZD":10,"VS":11,"SD":12,"VŽ":13,"KZ":14,"ZG":15,"PG":16,"ŠK":17,"LS":18,"BB":19,"GZ":20,"BP":21};
...
d3.json("croatia.json").then(function(croatiaData) {
  ...
  d3.json("hr.json").then(function(regionsData) {
   ...
   /* d3.json("hr_cities.json").then(function(citiesData) {
      // Draw the cities
